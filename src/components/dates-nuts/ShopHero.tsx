...
import { Award, Leaf, Activity, Gift } from 'lucide-react';
...
export default function ShopHero({ onSearchSubmit, items }: ShopHeroProps) {
  return (
    <section className="w-full bg-[#F8F2EA] relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-full sm:w-[70%] md:w-[65%] lg:w-[60%] h-full z-0">
        ...
        <div className="absolute inset-y-0 left-0 w-[85%] md:w-[60%] lg:w-[50%] bg-gradient-to-r from-[#F8F2EA] via-[#F8F2EA]/85 to-transparent" />
      </div>
    </section>
  );
}
