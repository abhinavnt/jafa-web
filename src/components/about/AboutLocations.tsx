      ...
      <div className="w-full max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 md:gap-6">
          {locations.map((loc, idx) => (
            <div 
              key={idx} 
              className="bg-[#F8F2EA] rounded-2xl overflow-hidden border border-[#DCD0C3]/50 flex flex-col transition-transform duration-300 hover:-translate-y-1 hover:shadow-md"
            >
              {/* Top Image */}
