...
export default function AboutHero() {
  return (
    ...
    <section className="w-full bg-[#F8F2EA] flex flex-col md:block md:relative md:overflow-hidden">
      ...
      {/* 
        MOBILE: image flows naturally below text, full-width, auto height.
                No gradient needed — the image's own cream background matches perfectly.
        DESKTOP: absolutely pinned to top-right, covers full section height,
                 with a left-side gradient fade.
      */}

      {/* Mobile image (shown only below md) */}
      <div className="block md:hidden w-full relative">
        <Image
          src="/images/about-hero-with-logo.png"
